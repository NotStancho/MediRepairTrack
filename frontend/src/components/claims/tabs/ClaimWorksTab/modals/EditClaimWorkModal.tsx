// components/claim/tabs/ClaimWorksTab/modals/EditClaimWorkModal

import { useMemo, useState } from 'react';

import type { ClaimWork } from '../../../../../types/claim/claimWork';
import type { UpdateClaimWorkPayload } from '../../../../../types/claim/claimWorkPayloads';
...
interface Props {
    ...
    noteOnly?: boolean;
    onClose: () => void;
    onSave: (payload: UpdateClaimWorkPayload) => Promise<void>;
}
...
export default function EditClaimWorkModal({
    claimWork,
    repairWorks,
    repairWorksLoading,
    updating,
    ...
    const [selectedRepairWorkId, setSelectedRepairWorkId] = useState<number | null>(
        claimWork.repairWorkId,
    );
    const [timeSpent, setTimeSpent] = useState(String(claimWork.timeSpent));
    const [note, setNote] = useState(claimWork.note ?? '');
