...
interface Props {
    creating: boolean;
    onClose: () => void;
    onCreate: (payload: CreateComplexityLevelPayload) => Promise<void>;
}

export default function CreateComplexityLevelModal({
    creating,
    onClose,
    onCreate,
}: Props) {
    ...
    return (
        <Modal title="Додати рівень складності" onClose={onClose} width="lg">
